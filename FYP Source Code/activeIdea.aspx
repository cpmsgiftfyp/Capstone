<%@ Page Language="C#" AutoEventWireup="true" CodeFile="activeIdea.aspx.cs" Inherits="activeIdea" %>
...
<body>
 ...
 <center> <h2>Active Projects</h2> </center>
                 <br>
                   ...
                   <ul class="list-group">
    <li class="list-group-item">Project Title: <br> Student: <br> Description: <br><br><br></li>
   <li class="list-group-item">Project Title: <br> Student: <br> Description: <br><br><br></li>
