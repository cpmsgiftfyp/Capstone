<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selectCapstoneIdea.aspx.cs" Inherits="selectCapstoneIdea" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Select Idea</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
  ...
  <ul class="navbar-nav">
    ...
    <div class="container">
        <center><h2>Select Idea</h2></center>

        

        <ul class="list-group">
    <li class="list-group-item">Idea Details:<p><br>Idea by: <br><br> <asp:Button ID="submitRequest" CssClass="btn btn-default" runat="server" Text="Request" /> </p></li>
           
    <li class="list-group-item">Idea Details:<p><br>Idea by: <br><br> <asp:Button ID="Button1" CssClass="btn btn-default" runat="server" Text="Request" /> </p></li>
