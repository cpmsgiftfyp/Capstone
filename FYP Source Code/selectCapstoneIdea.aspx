...
<body>
  ...
  <ul class="navbar-nav">
    ...
    <div class="container">
        ...
        <ul class="list-group">
    <li class="list-group-item">Idea Details:<p><br>Idea by: <br><br> <asp:Button ID="submitRequest" runat="server" Text="Request" /> </p></li>
           
    <li class="list-group-item">Idea Details:<p><br>Idea by: <br><br> <asp:Button ID="Button1" runat="server" Text="Request" /> </p></li>
